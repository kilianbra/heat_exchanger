...
try:
    ...
    print(f" p_static_out/p_static_in = {p_current / p_in:.6f}, p_stag_out/p_stag_in = {p_stag_final / p_stag_in:.6f}")
...
for i, ksi_val in enumerate(ksi_array):
    ...
    if theory_choked and solver_choked:
        print(f"  Both models choked, stopping at ksi = {ksi_val:.6e}")
        break

print(f"  Completed: Theory choked = {theory_choked}, Solver choked = {solver_choked}")
print()
