...
Run:
    uv run analysis/standalone_tools/plot_parahydrogen_ts_diagram.py --out-dir analysis/standalone_tools/figs
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-dir", type=Path, default=Path("analysis/standalone_tools/figs"), help="Output directory for figure.")
