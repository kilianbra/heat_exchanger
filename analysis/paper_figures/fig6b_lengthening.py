...
def save_figures(
    ...
    ax.yaxis.labelpad = -8  # After tight_layout: reduce distance between ticks and ylabel
...
if __name__ == "__main__":
    PLOT_AREA_RATIO_REF = False  # Set False for standard NTU x-axis; True saves fig6b_A_A_ref.svg etc.
    PLOT_REF_PLUS = True  # Set True to add + at reference design; saves fig6b_NTU_w_plus.svg when NTU axis
    save_figures(
